...
public  class Type extends haxe.lang.HxObject
{
	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		{
			java.lang.String __temp_svar34 = (name);
			int __temp_hash36 = __temp_svar34.hashCode();
			boolean __temp_executeDef35 = true;
			switch (__temp_hash36)
			{
				case -672261858:case 104431:
				{
					if (( (( ( __temp_hash36 == -672261858 ) && __temp_svar34.equals("Integer") )) || __temp_svar34.equals("int") )) 
					{
				...
				case -1939501217:
				{
					if (__temp_svar34.equals("Object")) 
					{
						__temp_executeDef35 = false;
						return "Dynamic";
					}
				...
				{
					if (( (( ( __temp_hash36 == 2052876273 ) && __temp_svar34.equals("Double") )) || __temp_svar34.equals("double") )) 
					{
						__temp_executeDef35 = false;
						return "Float";
					}
