...
public  class StringRefl
{
	...
	{
		{
			java.lang.String __temp_svar59 = (f);
			int __temp_hash61 = __temp_svar59.hashCode();
			boolean __temp_executeDef60 = true;
			switch (__temp_hash61)
			{
				case -1106363674:
				{
					if (__temp_svar59.equals("length")) 
					{
				...
				{
					if (( (( ( __temp_hash61 == 530542161 ) && __temp_svar59.equals("substring") )) || ( (( ( __temp_hash61 == -891529231 ) && __temp_svar59.equals("substr") )) || ( (( ( __temp_hash61 == 109648666 ) && __temp_svar59.equals("split") )) || ( (( ( __temp_hash61 == -467511597 ) && __temp_svar59.equals("lastIndexOf") )) || ( (( ( __temp_hash61 == 1943291465 ) && __temp_svar59.equals("indexOf") )) || ( (( ( __temp_hash61 == 397153782 ) && __temp_svar59.equals("charCodeAt") )) || ( (( ( __temp_hash61 == -1361633751 ) && __temp_svar59.equals("charAt") )) || ( (( ( __temp_hash61 == -1137582698 ) && __temp_svar59.equals("toLowerCase") )) || __temp_svar59.equals("toUpperCase") ) ) ) ) ) ) ) )) 
					{
						__temp_executeDef60 = false;
